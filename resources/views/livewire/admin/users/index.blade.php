...
<div class="antialiased sans-serif h-full relative">
  <div class="container mx-auto py-6 px-4" x-data="datatables()" x-cloak>
    <h1 class="text-3xl py-4 mt-10">Datatable</h1>

    <div x-show="selectedRows.length" class="absolute bg-primary top-0 left-0 right-0 z-40 w-full shadow">
      <div class="container mx-auto px-4 py-4">
        <div class="flex md:items-center">
          ...
          <div x-html="selectedRows.length + ' rows are selected'" class="text-white text-lg"></div>
        </div>
      </div>
    </div>
        ...
        <div class="shadow rounded-lg flex">
          <div class="relative">
            <button @click.prevent="open = !open"
              class="rounded-lg inline-flex items-center bg-white hover:text-black focus:outline-none focus:shadow-outline text-gray-500 font-semibold py-2 px-2 md:px-4">
              ...
              <td class="border-dashed border-t border-gray-200 px-3">
                <label
                  ...
                  <input type="checkbox" class="form-checkbox rowCheckbox focus:outline-none focus:shadow-outline"
                    :name="user.userId" @click="getRowDetail($event, user.userId)">
                </label>
              </td>
