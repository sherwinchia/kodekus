...
@section('content')
<div class="flex justify-center items-center h-48 bg-gray-200 mb-10">
  <h1>About Us</h1>
</div>
    ...
    <div class="flex justify-center w-full ">
      <div class="max-w-xl">
        ...
        <p class="text-lg mb-4">
          ...
          sebagai catatan untuk pembelajaran saya. Selain itu, saya juga ingin berbagi catatan pembelajaran saya dengan
        ...
        <p class="text-lg mb-4">
          ...
          sherwin.variancia@ {{ config('app.name') }} .com
        </p>
        <p class="text-lg">
          Terima Kasih.
        </p>
