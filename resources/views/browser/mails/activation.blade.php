                    ...
                    <td align="center"
                      ...
                      <div
                        ...
                        <h1 style="font-family: 'Cabin', sans-serif; text-align: center;"><span
                            style="font-family: 'courier new', courier, monospace; font-size: 48px;">Account
                            Activation</span></h1>
                      </div>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:15px 15px 15px 15px;word-break:break-word;">
                      ...
                      <div
                        ...
                        <p><span style="font-size: 20px; font-family: 'andale mono', monospace;">You're one step closer
                            to activate your account in {{ config('app.name') }}.</span></p>
                        <p><span style="font-size: 20px; font-family: 'andale mono', monospace;">Click on activate
                            button to activate your account </span></p>
                      </div>
